...
export default function RewardsTab() {
  const { currentBenefits, nextRewards, rewardGalleryCategories, loading } = useLevelDashboard();

  if (loading && currentBenefits.length === 0) {
    return (
    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        {nextRewards.length === 0 ? (
          <p className="text-xs text-gray-400 text-center py-4">All achievements unlocked! 🎉</p>
        ) : (
          <div className="grid grid-cols-2 gap-2.5">
            {nextRewards.map((r, i) => (
      ...
      <div>
        ...
        {rewardGalleryCategories.length === 0 ? (
