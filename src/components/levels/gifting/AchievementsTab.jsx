...
export default function AchievementsTab() {
  const { achievements, milestones, rarityColors, loading } = useLevelSubDashboard("gifting");
  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-[10px] text-gray-400 mb-3 px-1">Live supporter trophy showcase</p>
