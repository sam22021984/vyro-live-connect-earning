...
import { giftingBenefits, nextGiftingRewards, giftingGalleryCategories } from "@/components/levels/gifting/giftingData";
  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2.5">
          {giftingGalleryCategories.map((c, i) => (
