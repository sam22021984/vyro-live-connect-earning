...
import { streamStatistics, streamHistory } from "@/components/levels/streaming/streamingData";
  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        ...
        <p className="text-[10px] text-gray-400 mb-3 px-1">Advanced streaming analytics</p>
        <div className="grid grid-cols-2 gap-2.5">
          {streamStatistics.map((s, i) => (
