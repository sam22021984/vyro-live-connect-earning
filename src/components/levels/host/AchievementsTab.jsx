...
import { hostAchievements, hostMilestones, rarityColors } from "@/components/levels/host/hostData";
import { Lock, Trophy, Check, Crown } from "lucide-react";

export default function AchievementsTab() {
  const unlocked = hostAchievements.filter(a => a.unlocked).length;
  return (
    <div className="space-y-5">
      <div>
        ...
        <div className="grid grid-cols-4 gap-2 mb-4">
          {[{ l: "Total", v: hostAchievements.length, i: "🏆", c: "#FFC83D" }, { l: "Unlocked", v: unlocked, i: "✅", c: "#22C55E" }, { l: "Locked", v: hostAchievements.length - unlocked, i: "🔒", c: "#94A3B8" }, { l: "Rare+", v: hostAchievements.filter(a => ["Legendary","Mythic"].includes(a.rarity)).length, i: "⭐", c: "#A855F7" }].map((s, i) => (
