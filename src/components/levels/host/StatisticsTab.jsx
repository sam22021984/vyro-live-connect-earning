...
import { hostStatistics, hostHistory } from "@/components/levels/host/hostData";

export default function StatisticsTab() {
  return (
    <div className="space-y-5">
      <div>
        <h3 className="text-sm font-bold text-gray-800 mb-1 px-1">Host Statistics Dashboard</h3>
        <p className="text-[10px] text-gray-400 mb-3 px-1">Advanced host analytics</p>
        <div className="grid grid-cols-2 gap-2.5">
          {hostStatistics.map((s, i) => (
      ...
      <div>
        <h3 className="text-sm font-bold text-gray-800 mb-1 px-1">Host History</h3>
        <p className="text-[10px] text-gray-400 mb-3 px-1">Recent host activity</p>
