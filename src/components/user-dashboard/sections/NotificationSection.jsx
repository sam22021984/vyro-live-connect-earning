...
import { NOTIFICATION_DATA } from "../userDashboardData";
    ...
    <div className="space-y-4">
      <div>
        ...
        <div className="grid grid-cols-3 gap-2">
          {NOTIFICATION_DATA.categories.map((c, i) => (
      ...
      <GlassCard>
        ...
        <div className="space-y-2">
          {NOTIFICATION_DATA.recent.map((n, i) => (
      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-2">
          <ActionButton label="Mark as Read" icon="✅" color="#10B981" />
