...
import { Video, Download, X, Maximize2 } from "lucide-react";
import { COLORS, MEDIA_ITEMS } from "./communityData";
...
export default function MediaGalleryTab() {
  ...
  const filtered = filter === "All" ? MEDIA_ITEMS : MEDIA_ITEMS.filter((m) => m.category === filter);
