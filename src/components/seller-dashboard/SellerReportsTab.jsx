...
import { Search, X, Check, ChevronRight, FileText, Upload, Send, Clock } from "lucide-react";
...
export default function SellerReportsTab() {
    ...
    <div className="space-y-4">
      ...
      {activeView === "reports" && (
        <div className="space-y-4 animate-fadeIn">
          ...
          <div className="flex gap-1.5 overflow-x-auto scrollbar-hide">
            <button className="flex-shrink-0 px-3 py-1.5 rounded-full text-[10px] font-bold text-white" style={{ background: `${GOLD}15`, color: GOLD }}>
      ...
      {activeView === "actions" && (
        <div className="space-y-4 animate-fadeIn">
          <div className="rounded-2xl p-4" style={{ background: CARD_BG, border: `1px solid ${GOLD}15` }}>
          ...
          <div className="rounded-2xl p-4" style={{ background: CARD_BG, border: `1px solid ${TEAL}15` }}>
            <h3 className="text-xs font-bold text-white mb-3 flex items-center gap-1.5">
      ...
      {showCreateModal && (
        <div className="fixed inset-0 z-50 flex items-end justify-center">
          ...
          <div className="relative w-full max-w-md rounded-t-3xl max-h-[85vh] overflow-y-auto animate-fadeIn" style={{ background: CARD_BG, border: `1px solid ${GOLD}20` }}>
            ...
            <div className="px-4 pb-6 space-y-3">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full px-3 py-2.5 rounded-xl text-xs text-white placeholder-white/30 outline-none resize-none"
                  style={{ background: "rgba(255,255,255,0.05)", border: `1px solid ${TEAL}15` }}
                />
              </div>
              <div>
              ...
              <div className="flex gap-2 pt-1">
                <button onClick={() => handleAction("Save Draft")} className="flex-1 py-3 rounded-2xl text-sm font-bold text-white active:scale-[0.98] transition" style={{ background: "rgba(255,255,255,0.08)" }}>
                  Save Draft
                </button>
                <button onClick={handleCreateReport} className="flex-1 py-3 rounded-2xl text-sm font-bold text-black active:scale-[0.98] transition flex items-center justify-center gap-2" style={{ background: `linear-gradient(135deg, ${GOLD}, ${TEAL})`, boxShadow: `0 6px 20px ${GOLD}30` }}>
                  <Send size={14} /> Submit
                </button>
              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center">
          ...
          <div className="relative w-full max-w-md rounded-t-3xl max-h-[85vh] overflow-y-auto animate-fadeIn" style={{ background: CARD_BG, border: `1px solid ${getStatusColor(selectedReport.statusId)}30` }}>
            ...
            <div className="px-4 pb-6 space-y-3">
              ...
              <div className="rounded-xl p-3" style={{ background: `${TEAL}08`, border: `1px solid ${TEAL}15` }}>
